<template>
  <div>
    <p v-if="loading"><img src="../assets/loading.gif" alt="loading"></p>
    <div v-for="card in cards" :key="card.id">
      <p>{{card.question}}</p>
      <p>{{card.answer}}</p>
      <p>{{card.example}}</p>
      <p>
        <span v-on:click="deleteCard(card.card_id)">delete</span>
      </p>
      <span v-on:click="handleClick(card); ">edit</span>
    ...
    <p v-on:click="showNewCardFormFlip()">create a new card</p>
